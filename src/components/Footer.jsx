import cucLogo from "../img/CUC.png";
    ...
    <footer className="footer">
      ...
      <div className="footer__contenedor">
        <div className="footer__texto">
          <div className="footer__organizacion">
            <h4>Universidad:</h4>
            <div className="footer__imagen">
              <img className="footer__logo" src={cucLogo} alt="CUC" />              
            </div>
            <a className="footer_cuc" href="https://www.cuc.ac.cr/">
                Colegio Universitario de Cartago
            </a>
          </div>
          <div className="footer__estudiantes">
            <h4>Proyecto realizado y diseñdo por:</h4>
            <p className="owner">
              <span>B</span>randon <span>G</span>ómez <span>C</span>arvajal
            </p>
            <div className="card">
